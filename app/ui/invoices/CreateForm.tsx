        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              id="customer"
              name="customerId"
              className="peer block w-full cursor-pointer rounded-md border border-gray-100 bg-white py-2 pl-10 pr-3 text-sm text-gray-700 placeholder:text-gray-400 shadow-sm focus:border-blue-400 focus:ring-1 focus:ring-blue-300"
              defaultValue=""
            >
        ...
        <div className="mb-4">
          ...
          <div className="relative mt-2 rounded-md">
            <input
              ...
              className="peer block w-full rounded-md border border-gray-100 bg-white py-2 pl-10 pr-3 text-sm text-gray-700 placeholder:text-gray-400 shadow-sm focus:border-blue-400 focus:ring-1 focus:ring-blue-300"
            />
